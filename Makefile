...
WEB_HOST ?= 127.0.0.1
WEB_PORT ?= 5173
XUANNIAO_AGENT_TRANSPORT ?= codex
...
run:
	...
	@HOST=$(SERVER_HOST) PORT=$(SERVER_PORT) XUANNIAO_AGENT_TRANSPORT=$(XUANNIAO_AGENT_TRANSPORT) XUANNIAO_AGENT_MODE=$(XUANNIAO_AGENT_MODE) npm start -- $(FILE) & \
	server_pid=$$!; \
